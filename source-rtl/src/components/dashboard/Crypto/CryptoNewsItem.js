        ...
        <div className="gx-news-tags-row">
          <div className="gx-news-tags-left">
            <p className="gx-text-grey gx-mb-0 gx-text-truncate"><i
              className={`icon icon-tag-new gx-fs-lg gx-ml-2 gx-d-inline-flex gx-vertical-align-middle gx-text-light-grey`}/>{desc}
            </p>
          </div>
          <div className="gx-news-tags-right">
            <p className="gx-text-primary gx-pointer gx-mb-0">داستان کامل آماده
              <i className={`icon icon-long-arrow-left gx-fs-xl gx-mr-2 gx-d-inline-flex gx-vertical-align-middle`}/>
            </p>
          </div>
        </div>
      </div>
