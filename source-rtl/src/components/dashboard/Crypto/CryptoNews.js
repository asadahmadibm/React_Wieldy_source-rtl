    ...
    return (
      <Widget>
        <div className="ant-row-flex gx-justify-content-between gx-mb-3 gx-dash-search">
          <h2 className="h4 gx-mb-3 gx-mb-sm-1 gx-mr-2">اخبار رمزنگاری</h2>
          <div className="gx-mx-sm-2">
            <Radio.Group className="gx-radio-group-link gx-radio-group-link-news" defaultValue={0}
              ...
              <Radio.Button value={1} className="gx-mb-1">بیت کوین</Radio.Button>
              <Radio.Button value={2} className="gx-mb-1">موج دار شدن</Radio.Button>
              <Radio.Button value={3} className="gx-mb-1">بیت</Radio.Button>
            </Radio.Group>
          </div>
