      ...
      <div className="gx-media gx-task-list-item gx-flex-nowrap">
        ...
        <div className="gx-media-body gx-task-item-content">
          ...
          <div className="gx-task-item-content-right">
            <Avatar className=" gx-size-30 gx-order-sm-3" src={user.avatar} />
            <Tag
              className="gx-bg-grey gx-text-grey gx-ml-3 gx-ml-0 gx-mb-0 gx-rounded-xxl gx-order-sm-2">{user.projectName}</Tag>
            <ul className="gx-dot-list gx-mb-0 gx-order-sm-1 gx-ml-2">
              {getTags(tags)}
            </ul>
            <span className="gx-fs-sm gx-text-grey gx-mr-3 gx-task-date gx-order-sm-4">{dueDate}</span>
          </div>
        </div>
      </div>
    </Aux>
