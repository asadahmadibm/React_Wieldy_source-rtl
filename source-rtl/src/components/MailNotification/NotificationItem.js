...
const NotificationItem = ({notification}) => {
  ...
  return (
    <li className="gx-media">
      <div className="gx-user-thumb gx-ml-3">
      ...
      <div className="gx-media-body">
        ...
        <span className="gx-btn gx-btn-sm gx-top2 gx-text-muted"><i className="icon icon-reply gx-pr-2"/>پاسخ</span>
        <span className="gx-btn gx-btn-sm gx-top2 gx-text-muted"><i
          className="icon icon-custom-view gx-pr-2"/>خواندن</span>
      </div>
    </li>
  );
};
