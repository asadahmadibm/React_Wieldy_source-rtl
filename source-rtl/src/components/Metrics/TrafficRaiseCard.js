...
const data = [
  {name: 'صفحه اول', traffic: 200},
  {name: 'صفحه دوم', traffic: 1100},
  {name: 'صفحه سوم', traffic: 800},
  {name: 'صفحه چهارم', traffic: 1700},
  {name: 'صفحه چهارم', traffic: 600},
  {name: 'صفحه چهارم', traffic: 1800},
  {name: 'صفحه چهارم', traffic: 600},
];
      ...
      <Row className="gx-align-items-center">
        <Col lg={12} md={12} sm={24} xs={24}>
          <div className="gx-actchart gx-px-3">
            ...
            <p className="gx-mb-0">افزایش ترافیک</p>
          </div>
        </Col>
        <Col lg={12} md={12} sm={24} xs={24}>
