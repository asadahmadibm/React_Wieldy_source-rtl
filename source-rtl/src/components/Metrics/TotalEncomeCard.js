  ...
  return (
    <Widget styleName={`gx-card-full`}>
      <div className="gx-d-flex gx-px-4 gx-pt-4 gx-pb-2">
        <p className="gx-text-uppercase gx-chart-title">درآمد سال گذشته</p>
        <p className="gx-mr-auto gx-text-primary">67% <i className="icon icon-menu-up gx-fs-sm"/></p>
      </div>
      <Row>
        <Col lg={12} md={12} sm={24} xs={24}>
          <div className="gx-actchart gx-pb-5 gx-pr-4">
            <h2 className="gx-fs-xxxl gx-font-weight-medium gx-mb-1 gx-text-black">200000</h2>
            <p className="gx-mb-0">درآمد کلی</p>
          </div>
        </Col>
        <Col lg={12} md={12} sm={24} xs={24}>
