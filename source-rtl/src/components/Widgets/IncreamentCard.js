...
const data = [
  { name: 'صفحه A', increment: 200 },
  { name: 'صفحه B', increment: 1000 },
  { name: 'صفحه C', increment: 600 },
  { name: 'صفحه D', increment: 1600 },
  { name: 'صفحه D', increment: 1000 },
  { name: 'صفحه H', increment: 2260 },
  { name: 'صفحه K', increment: 400 },
];
  ...
  return (
    <Widget styleName="gx-card-full">
      ...
      <div className="gx-actchart gx-px-3 gx-pt-3 gx-pb-2 gx-d-flex gx-flex-row">
        <h2 className="gx-mb-0 gx-ml-2 gx-fs-lg">84% <i className="icon icon-menu-up gx-fs-sm" /></h2>
        <p className="gx-mb-0 gx-text-grey gx-fs-sm">افزایش در کاربران فعال</p>
      </div>
