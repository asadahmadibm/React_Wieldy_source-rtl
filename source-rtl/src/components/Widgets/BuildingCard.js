  ...
  return (
    <Widget styleName="gx-card-full gx-dot-arrow-hover">
      <div className="gx-media gx-align-items-center gx-flex-nowrap">
        ...
        <div className="gx-media-body gx-py-3 gx-pl-4 gx-build-box-lay-content">

          <Badge className="gx-badge-radius-sm gx-mb-2" count="34 جدید" style={{ backgroundColor: '#52c41a' }} />
          <h2 className="h4 gx-text-truncate gx-mb-1">خانه و دفاتر</h2>

          <p className="gx-mb-0 gx-text-grey gx-fs-sm">ویژگی های این هفته</p>
