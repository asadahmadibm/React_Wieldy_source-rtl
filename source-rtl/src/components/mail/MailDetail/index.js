        ...
        <CustomScrollbars className="gx-module-content-scroll">
          <div className="gx-mail-detail-inner">
            ...
            <div className="gx-mail-user-info gx-ml-0 gx-mb-3">
              ...
              {mail.from.avatar === '' ?
                <Avatar
                  className="gx-avatar gx-bg-blue gx-size-40 gx-ml-3"> {mail.from.name.charAt(0).toUpperCase()}</Avatar> :
                <Avatar className="gx-size-40 gx-ml-3" alt="Alice Freeman"
                        src={mail.from.avatar}/>
              }

              <div className="gx-sender-name">{mail.from.name}
                <div className="gx-send-to gx-text-grey">به من</div>
              </div>
            ...
            {this.state.showDetail && (<div className="gx-show-detail">
              <div>
                <strong>از جانب: </strong>{mail.from.email}
              </div>
              <div>
                <strong> به : </strong>
                {
              ...
              <div><strong>تاریخ: </strong>{mail.time} </div>
            </div>)}
            ...
            <div className="gx-attachment-block">
              <h3>پیوست ها ({mail.attachments.length})</h3>
