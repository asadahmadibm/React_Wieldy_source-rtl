      ...
      <Card className="gx-card">
        <div className="gx-wall-content">
          <div className="gx-media gx-wall-user-info gx-flex-nowrap gx-align-items-center">
            <Avatar className="gx-ml-3 gx-mb-2 gx-size-50" src={user.image} />
          ...
          <div className="gx-flex-row gx-mb-2 gx-mb-xl-3">
            <p className="gx-fs-sm gx-pointer gx-ml-3 gx-text-grey">
              <i className="icon icon-view-o gx-fs-lg gx-ml-2 gx-d-inline-flex gx-vertical-align-middle" />
              <span
                className="gx-d-inline-flex gx-vertical-align-middle">{viewCount > 0 ? viewCount + ' دیده شده' : 'دیده شده'}</span>
            </p>
            <p className="gx-fs-sm gx-pointer gx-ml-3 gx-text-grey" onClick={this.handleLikeToggle.bind(this)}>
              {isLike === true ?
                <i className="icon icon-like gx-fs-lg gx-ml-2 gx-d-inline-flex gx-vertical-align-middle"
                  style={{ color: 'blue' }} /> :
                <i className="icon icon-like-o gx-fs-lg gx-ml-2 gx-d-inline-flex gx-vertical-align-middle" />}
              <span
                className="gx-d-inline-flex gx-vertical-align-middle">{likeCount > 0 ? likeCount + ' پسندیدن' : 'پسندیدن'}</span>

            </p>
            <p className="gx-fs-sm gx-pointer gx-ml-3 gx-text-grey">
              <i className="icon icon-chat-bubble gx-fs-lg gx-ml-2 gx-d-inline-flex gx-vertical-align-middle" />
              <span
                className="gx-d-inline-flex gx-vertical-align-middle">{commentList.length > 0 ? commentList.length + ' نظرات' : 'نظرات'}</span>
            </p>
          </div>
          ...
          <div className="gx-wall-comment-box">
            <div className="gx-media gx-mb-2">
              <Avatar className="gx-ml-3 gx-size-36" src={user.image} />
              <div className="gx-media-body">
                <textarea
