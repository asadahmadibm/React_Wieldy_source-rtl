  ...
  render() {
    ...
    return (
      <div className="gx-media gx-flex-nowrap gx-wall-user-info gx-mb-3">
        <Avatar className="gx-ml-3 gx-size-40" src={user.image} />
        <div className="gx-media-body">
          ...
          <div className="gx-flex-row">
            <Button type="primary" size="small"
              onClick={this.handleLikeToggle.bind(this)}>{isLike === true ? 'پسندیدن' : 'نپسندیدن'}</Button>
            <Button className="gx-btn-primary-light" size="small"
              onClick={this.handleCommentToggle.bind(this)}>اظهار نظر</Button>
          </div>
          {this.state.isComment === true ? <div className="gx-media">
            <Avatar className="gx-ml-3 gx-size-30" src={user.image} />
            <div className="gx-media-body">
              <input
