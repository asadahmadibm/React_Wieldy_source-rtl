    ...
    return (
      <Card className="gx-card">
        <div className="gx-media gx-mb-2">
          <Avatar className="gx-size-50 gx-ml-3" src={this.props.user.image} />
        ...
        <div className="ant-row-flex">
          <div className="gx-pointer" onClick={this.handleClickImage.bind(this)}>
            <i className="icon icon-camera gx-ml-2 gx-fs-xl gx-d-inline-flex gx-vertical-align-middle" />
            <span className="gx-fs-sm"> اضافه کردن عکس / آلبوم </span>
          </div>

          <Button type="primary" size='small' className="gx-mr-auto gx-mb-0"
            disabled={(isEnabled) ? "disabled" : ""}
            onClick={this.handleAddPost.bind(this)}>ارسال
          </Button>
        </div>
      </Card>
    )
