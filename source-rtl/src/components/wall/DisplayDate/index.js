...
const DisplayDate = ({date}) => {
  ...
  switch (true) {
    case minutes === 0:
      return <p className="gx-text-grey gx-fs-sm gx-mb-0">همین الان</p>;
    case minutes < 60:
      return <p className="gx-text-grey gx-fs-sm gx-mb-0">{minutes} دقیه</p>;
    case hours < 24:
      return <p className="gx-text-grey gx-fs-sm gx-mb-0">{hours} ساعت</p>;
    default:
