        ...
        <Row>
          <Col xl={6} lg={8} md={8} sm={10} xs={24} className="gx-d-none gx-d-sm-block">
            <CustomScrollbars className="gx-wall-scroll">
              ...
              <Photos photoList={photoList} title="عکس ها" />
              <span className="gx-text-primary gx-fs-md gx-pointer gx-d-block gx-mb-4">به گالری بروید <i
          ...
          <Col xl={6} lg={8} md={6} sm={24} xs={24} className="gx-d-none gx-d-lg-block">
            <CustomScrollbars className="gx-wall-scroll">
              ...
              <span className="gx-text-primary gx-fs-md gx-pointer gx-d-block gx-mb-4">مشاهده همه انجمن ها <i
                className={`icon icon-long-arrow-left gx-fs-xxl gx-mr-2 gx-d-inline-flex gx-vertical-align-middle`} /></span>
