...
class Mail extends PureComponent {
    ...
    return <div className="gx-module-side">
      ...
      <div className="gx-module-side-header">
        <div className="gx-module-logo">
          <i className="icon icon-chat gx-ml-4" />
        ...
        <CustomScrollbars className="gx-module-side-scroll">
          <div className="gx-module-add-task">
            <Button type="primary" className="gx-btn-block"
              ...
              <i className="icon icon-edit gx-ml-2" />
  ...
  onDeleteMail = () => {
    ...
    this.setState({
      alertMessage: 'نامه با موفقیت حذف شد',
      showMessage: true,
      selectedMails: 0,
      allMail: mails,
    ...
    return folders.map((folder, index) =>
      <li key={index} onClick={() => {
        ...
        this.setState({
          ...
          noContentFoundMessage: 'هیچ نامه ای در پوشه انتخاب شده یافت نشد',
          currentMail: null,
          loader: true,
  ...
  onFolderMenuItemSelect = (e) => {
    ...
    this.setState({
      ...
      allMail: mails,
      noContentFoundMessage: 'هیچ نامه ای در پوشه انتخاب شده یافت نشد',
      alertMessage: 'نامه با موفقیت منتقل شد',
      showMessage: true,
      folderMails: mails.filter(mail => mail.folder === this.state.selectedFolder)
    });
  };
  ...
  onLabelMenuItemSelect = (e) => {
    ...
    this.setState({
      noContentFoundMessage: 'هیچ نامه ای در برچسب انتخاب شده یافت نشد',
      alertMessage: 'برچسب با موفقیت به روز شد',
      showMessage: true,
      allMail: mails,
      folderMails: mails.filter(mail => mail.folder === this.state.selectedFolder)
    });
  ...
  getNavFilters = () => {
    return filters.map((filter, index) =>
      <li key={index} onClick={() => {
        ...
        this.setState({
          noContentFoundMessage: 'هیچ نامه ای در فیلتر انتخابی یافت نشد',
          loader: true,
          folderMails: filterMails
        });
        setTimeout(() => {
  ...
  onMailSend(data) {
    this.setState(
      {
        alertMessage: 'نامه با موفقیت ارسال شد',
        showMessage: true,
        ...
        <div className="gx-app-module">
          ...
          <div className="gx-module-box">
            <div className="gx-module-box-header">
              ...
              <AppModuleHeader placeholder="جستجوی نامه ها" user={this.state.user}
            ...
            <div className="gx-module-box-content">
              <div className="gx-module-box-topbar">
                {this.state.currentMail === null ?
                  ...
                  :
                  <i className="icon icon-arrow-right gx-icon-btn" onClick={() => {
