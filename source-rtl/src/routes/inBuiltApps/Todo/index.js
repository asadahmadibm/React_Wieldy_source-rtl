...
class ToDo extends Component {
  ...
  onMarkAsStart = (data) => {
    ...
    this.setState({
      alertMessage: 'کار با موفقیت به روز شد',
      showMessage: true,
      allToDos: toDos,
      toDos: toDos,
    });
  ...
  onDeleteToDo = (data) => {
    ...
    this.setState({
      alertMessage: 'کار با موفقیت حذف شد',
      showMessage: true,
      allToDos: toDos,
      currentTodo: null,
      selectedToDos: selectedToDos,
    ...
    return <div className="gx-module-side">
      <div className="gx-module-side-header">
        <div className="gx-module-logo">
          <i className="icon icon-check-circle-o gx-ml-4" />
          ...
          <div className="gx-module-box">
            <div className="gx-module-box-header">
              ...
              <span className="gx-drawer-btn gx-d-flex gx-d-lg-none">
                <i className="icon icon-menu gx-icon-btn" aria-label="منو"
                  onClick={this.onToggleDrawer.bind(this)} />
              </span>
              <AppModuleHeader placeholder="جستجو در لیست" user={this.state.user}
