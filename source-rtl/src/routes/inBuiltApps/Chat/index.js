...
class Chat extends Component {
          ...
          <div className="gx-col">
            <div className="gx-form-group">
                            <textarea
                              ...
                              value={message}
                              placeholder="برای ارسال پیام وارد شوید"
                            />
            </div>
          </div>
    ...
    return <div className="gx-chat-sidenav-main">
      <div className="gx-bg-grey-light gx-chat-sidenav-header">
        ...
        <div className="gx-chat-user gx-chat-user-center">
          ...
          <div className="gx-user-name h4 gx-my-2">خلیل عزیزی</div>
            ...
            <form>
              <div className="gx-form-group gx-mt-4">
                ...
                <Input
                  ...
                  onKeyUp={this._handleKeyPress.bind(this)}
                  onChange={this.updateMessageValue.bind(this)}
                  defaultValue="این یک وضعیت است ... نه دفترچه خاطرات شما ..."
                  placeholder="وضعیت"
                  margin="none"/>
    ...
    return <div className="gx-chat-sidenav-main">
      ...
      <div className="gx-chat-sidenav-header">
        ...
        <div className="gx-chat-user-hd">
          ...
          <div className="gx-chat-avatar gx-ml-3" onClick={() => {
            this.setState({
              userState: 2
            });
          }}>
            <div className="gx-status-pos">
              <Avatar id="avatar-button" src={avatar4}
          ...
          <div className="gx-module-user-info gx-flex-column gx-justify-content-center">
            <div className="gx-module-title">
              <h5 className="gx-mb-0">خلیل عزیزی</h5>
            </div>
        ...
        <div className="gx-chat-search-wrapper">
          ...
          <SearchBox styleName="gx-chat-search-bar gx-lt-icon-search-bar-lg"
                     placeholder="گپ جدید را جستجو یا شروع کنید"
  ...
  constructor() {
    ...
    this.state = {
      loader: false,
      userNotFound: 'هیچ کاربری یافت نشد',
      drawerState: false,
      selectedSectionId: '',
      selectedTabIndex: 1,
      userState: 1,
