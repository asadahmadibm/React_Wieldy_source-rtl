...
const filterOptions = [
  {
    ...
    id: 2,
    name: 'اغلب در لیست تماس',
    icon: 'frequent'

  }, {

    id: 3,
    name: 'مخاطبین ستاره دار',
    icon: 'star'
  }
];
...
class Contact extends Component {
    ...
    return <div className="gx-module-side">
      <div className="gx-module-side-header">
        <div className="gx-module-logo">
          <i className="icon icon-contacts gx-ml-4" />
        ...
        <CustomScrollbars className="gx-module-side-scroll">
          <div className="gx-module-add-task">
            <Button className="gx-btn-block ant-btn" type="primary" aria-label="add"
              ...
              <i className="icon icon-add gx-ml-2" />
  ...
  constructor() {
    super();
    this.state = {
      noContentFoundMessage: 'در پوشه انتخاب شده هیچ تماسی یافت نشد',
      alertMessage: '',
      showMessage: false,
      selectedSectionId: 1,
      drawerState: false,
        ...
        <div className="gx-app-module">
          ...
          <div className="gx-module-box">
            <div className="gx-module-box-header">
              ...
              <AppModuleHeader placeholder="تماس با ما جستجو کنید" notification={false} apps={false}
