...
class HorizontalLoginForm extends Component {
  ...
  render() {
    ...
    return (
      <Card className="gx-card" title="فرم ورود به سیستم افقی">
        <Form onSubmit={this.handleSubmit} className="gx-login-form gx-form-row0">
          ...
          <FormItem>
            ...
            <span className="gx-link login-form-forgot">رمز عبور را فراموش کرده اید</span>
            <Button type="primary" htmlType="ارسال" className="login-form-button">
              ورود
            </Button>
            یا <span className="gx-link">هم اکنون ثبت نام کنید!</span>
          </FormItem>
        </Form>
